import{R as d}from"./index-RYns6xqu.js";import{R as m}from"./cloneDeep-Q-bFRGJl.js";import{G as p}from"./index-Drr1lRpf.js";import"./index-BQ5IbGbl.js";import"./index-4sF_yb9E.js";import"./index-CpOIycTO.js";import"./index-B5-wn6KZ.js";import"./colors-CMe-4sOE.js";const R={title:"Charts/Gauge"};function e(){const r={title:"仪表盘",data:{target:120,total:400,percent:.6},width:720};return d.createElement(p,{...r,renderer:new m})}function t(){const r={title:"无数据仪表盘",data:{target:0,total:400,percent:0},width:720};return d.createElement(p,{...r,renderer:new m})}e.__docgenInfo={description:"",methods:[],displayName:"Basic"};t.__docgenInfo={description:"",methods:[],displayName:"ZeroGauge"};var n,a,o;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`function Basic() {
  ...
  // @ts-expect-error 暂时忽略
  return <Gauge {...config} renderer={new SVGRenderer()} />;
}`,...(s=(i=t.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};const _=["Basic","ZeroGauge"];export{e as Basic,t as ZeroGauge,_ as __namedExportsOrder,R as default};
